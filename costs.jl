...
function Calculate_new_cost_add_two(tour::Vector{Int}, cost::Float64, city1::Int, city2::Int, position::Int, T::Matrix{Float64}, n_nodes::Int)
    nt = length(tour)
    if nt == 0 
        return T[1, city1+1] + T[city1+1, city2+1] + T[city2+1, n_nodes+2]
    end
    if position == 1
...
function Calculate_new_cost_add_three(tour::Vector{Int}, cost::Float64, city1::Int, city2::Int, city3::Int, position::Int, T::Matrix{Float64}, n_nodes::Int)
    nt = length(tour)
    if nt == 0 
        return T[1, city1+1] + T[city1+1, city2+1] + T[city2+1, city3+1] + T[city3+1, n_nodes+2]
    end
    if position == 1
        cost += T[1, city1+1] + T[city1+1, city2+1] + T[city2+1, city3+1] + T[city3+1, tour[1]+1] - T[1,tour[1]+1]
    elseif position == nt+1
        cost += T[city3+1, n_nodes+2] + T[city1+1, city2+1] + T[city2+1, city3+1] + T[tour[nt]+1, city1+1] - T[tour[nt]+1, n_nodes+2]
    else
        cost += T[tour[position-1]+1, city1+1] + T[city1+1, city2+1] + T[city2+1, city3+1] + T[city3+1, tour[position]+1]-T[tour[position-1]+1,tour[position]+1]
    end
    return cost
end
...
function Calculate_new_cost_swap_two_reverse_straight(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
   if nt1 == 2
    ...
    if nt2 == 2
        new_cost2 = T[1, city12+1] + T[city12+1, city11+1] + T[city11+1, n_nodes+2] 
    else
        if position2 == 1
            new_cost2 += T[1, city12+1] + T[city12+1, city11+1]  + T[city11+1, tour2[3]+1] - T[1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[3]+1]
        elseif position2 == nt2-1
            new_cost2 += T[tour2[nt2-2]+1, city12+1] + T[city12+1, city11+1] + T[city11+1, n_nodes+2] - T[tour2[nt2-2]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, n_nodes+2]
        else
            new_cost2 += T[tour2[position2-1]+1, city12+1] + T[city12+1, city11+1] + T[city11+1, tour2[position2+2]+1] - T[tour2[position2-1]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[position2+2]+1]
        end
    end
    return new_cost1, new_cost2
end

function Calculate_new_cost_swap_two_straight_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    if nt1 == 2
        new_cost1 = T[1, city22+1] + T[city22+1, city21+1] + T[city21+1, n_nodes+2] 
    else
        if position1 == 1
            new_cost1 += T[1, city22+1] + T[city22+1, city21+1]  + T[city21+1, tour1[3]+1] - T[1, city11+1] - T[city11+1, city12+1] - T[city12+1, tour1[3]+1]
        elseif position1 == nt1-1
            new_cost1 += T[tour1[nt1-2]+1, city22+1] + T[city22+1, city21+1] + T[city21+1, n_nodes+2] - T[tour1[nt1-2]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, n_nodes+2]
        else
            new_cost1 += T[tour1[position1-1]+1, city22+1] + T[city22+1, city21+1] + T[city21+1, tour1[position1+2]+1] - T[tour1[position1-1]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, tour1[position1+2]+1]
        end
    end
...
function Calculate_new_cost_swap_two_reverse_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
...
function Calculate_new_cost_swap_three(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, city23::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    if nt1 == 3
        new_cost1 = T[1, city21+1] + T[city21+1, city22+1] + T[city22+1, city23+1] + T[city23+1, n_nodes+2] 
    else
        if position1 == 1
            new_cost1 += T[1, city21+1] + T[city21+1, city22+1] + T[city22+1, city23+1]  + T[city23+1, tour1[4]+1] - T[1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[4]+1]
        elseif position1 == nt1-2
            new_cost1 += T[tour1[nt1-3]+1, city21+1] + T[city21+1, city22+1] + T[city22+1, city23+1] + T[city23+1, n_nodes+2] - T[tour1[nt1-3]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, n_nodes+2]
        else
            new_cost1 += T[tour1[position1-1]+1, city21+1] + T[city21+1, city22+1]  + T[city22+1, city23+1] + T[city23+1, tour1[position1+3]+1] - T[tour1[position1-1]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[position1+3]+1]
        end
    end
    ...
    if nt2 == 3
        ...
        if position2 == 1
            new_cost2 += T[1, city11+1] + T[city11+1, city12+1] + T[city12+1, city13+1]  + T[city13+1, tour2[4]+1] - T[1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, tour2[4]+1]
        elseif position2 == nt2-2
            new_cost2 += T[tour2[nt2-3]+1, city11+1] + T[city11+1, city12+1] + T[city12+1, city13+1] + T[city13+1, n_nodes+2] - T[tour2[nt2-3]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, n_nodes+2]
        else
            new_cost2 += T[tour2[position2-1]+1, city11+1] + T[city11+1, city12+1]  + T[city12+1, city13+1] + T[city13+1, tour2[position2+3]+1] - T[tour2[position2-1]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, tour2[position2+3]+1]
        end
    end
    return new_cost1, new_cost2
end

function Calculate_new_cost_swap_three_straight_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, city23::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    if nt1 == 3
        new_cost1 = T[1, city23+1] + T[city23+1, city22+1] + T[city22+1, city21+1] + T[city21+1, n_nodes+2] 
    else
        if position1 == 1
            new_cost1 += T[1, city23+1] + T[city23+1, city22+1] + T[city22+1, city21+1]  + T[city21+1, tour1[4]+1] - T[1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[4]+1]
        elseif position1 == nt1-2
            new_cost1 += T[tour1[nt1-3]+1, city23+1] + T[city23+1, city22+1] + T[city22+1, city21+1] + T[city21+1, n_nodes+2] - T[tour1[nt1-3]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, n_nodes+2]
        else
            new_cost1 += T[tour1[position1-1]+1, city23+1] + T[city23+1, city22+1]  + T[city22+1, city21+1] + T[city21+1, tour1[position1+3]+1] - T[tour1[position1-1]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[position1+3]+1]
        end
    end
...
function Calculate_new_cost_swap_three_reverse_straight(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, city23::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    ...
    if nt2 == 3
        ...
        if position2 == 1
            new_cost2 += T[1, city13+1] + T[city13+1, city12+1] + T[city12+1, city11+1]  + T[city11+1, tour2[4]+1] - T[1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, tour2[4]+1]
        elseif position2 == nt2-2
            new_cost2 += T[tour2[nt2-3]+1, city13+1] + T[city13+1, city12+1] + T[city12+1, city11+1] + T[city11+1, n_nodes+2] - T[tour2[nt2-3]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, n_nodes+2]
        else
            new_cost2 += T[tour2[position2-1]+1, city13+1] + T[city13+1, city12+1]  + T[city12+1, city11+1] + T[city11+1, tour2[position2+3]+1] - T[tour2[position2-1]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, city23+1] - T[city23+1, tour2[position2+3]+1]
        end
    end
    return new_cost1, new_cost2
end

function Calculate_new_cost_swap_three_reverse_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, city23::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
...
function Calculate_new_cost_swap_three_with_two(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    if nt1 == 3
        ...
        if position1 == 1
            new_cost1 += T[1, city21+1] + T[city21+1, city22+1] + T[city22+1, tour1[4]+1] - T[1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[4]+1]
        elseif position1 == nt1-2
            new_cost1 += T[tour1[nt1-3]+1, city21+1] + T[city21+1, city22+1] + T[city22+1, n_nodes+2] - T[tour1[nt1-3]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, n_nodes+2]
        else
            new_cost1 += T[tour1[position1-1]+1, city21+1] + T[city21+1, city22+1] + T[city22+1, tour1[position1+3]+1] - T[tour1[position1-1]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[position1+3]+1]
        end
    end
    ...
    if nt2 == 3
        ...
        if position2 == 1
            new_cost2 += T[1, city11+1] + T[city11+1, city12+1] + T[city12+1, city13+1]  + T[city13+1, tour2[3]+1] - T[1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[3]+1]
        elseif position2 == nt2-1
            new_cost2 += T[tour2[nt2-2]+1, city11+1] + T[city11+1, city12+1] + T[city12+1, city13+1] + T[city13+1, n_nodes+2] - T[tour2[nt2-2]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, n_nodes+2]
        else
            new_cost2 += T[tour2[position2-1]+1, city11+1] + T[city11+1, city12+1]  + T[city12+1, city13+1] + T[city13+1, tour2[position2+2]+1] - T[tour2[position2-1]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[position2+2]+1]
        end
    end
    return new_cost1, new_cost2
end

function Calculate_new_cost_swap_three_with_two_reverse_straight(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    ...
    if nt2 == 3
        ...
        if position2 == 1
            new_cost2 += T[1, city13+1] + T[city13+1, city12+1] + T[city12+1, city11+1]  + T[city11+1, tour2[3]+1] - T[1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[3]+1]
        elseif position2 == nt2-1
            new_cost2 += T[tour2[nt2-2]+1, city13+1] + T[city13+1, city12+1] + T[city12+1, city11+1] + T[city11+1, n_nodes+2] - T[tour2[nt2-2]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, n_nodes+2]
        else
            new_cost2 += T[tour2[position2-1]+1, city13+1] + T[city13+1, city12+1]  + T[city12+1, city11+1] + T[city11+1, tour2[position2+2]+1] - T[tour2[position2-1]+1, city21+1] - T[city21+1, city22+1] - T[city22+1, tour2[position2+2]+1]
        end
    end
    return new_cost1, new_cost2
end

function Calculate_new_cost_swap_three_with_two_straight_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2
    if nt1 == 3
        ...
        if position1 == 1
            new_cost1 += T[1, city22+1] + T[city22+1, city21+1] + T[city21+1, tour1[4]+1] - T[1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[4]+1]
        elseif position1 == nt1-2
            new_cost1 += T[tour1[nt1-3]+1, city22+1] + T[city22+1, city21+1] + T[city21+1, n_nodes+2] - T[tour1[nt1-3]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, n_nodes+2]
        else
            new_cost1 += T[tour1[position1-1]+1, city22+1] + T[city22+1, city21+1] + T[city21+1, tour1[position1+3]+1] - T[tour1[position1-1]+1, city11+1] - T[city11+1, city12+1] - T[city12+1, city13+1] - T[city13+1, tour1[position1+3]+1]
        end
    end
...
function Calculate_new_cost_swap_three_with_two_reverse_reverse(tour1::Vector{Int}, cost1::Float64, city11::Int, city12::Int, city13::Int, position1::Int, tour2::Vector{Int}, cost2::Float64, city21::Int, city22::Int, position2::Int,T::Matrix{Float64}, n_nodes::Int)
    nt1 = length(tour1)
    nt2 = length(tour2)
    new_cost1 = cost1
    new_cost2 = cost2

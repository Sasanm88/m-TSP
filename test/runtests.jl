...
num_customers = 20   # This is N in table 2
num_salesmen = 5     # This is m in table 2
num_instances = 2  # This is the number of instances you want to solve for each combination of N and m (in our paper, we solved 100 instances)
verbose = true      # Set this to true if you want to print the detailed results for each instance
